...
export default function LaporanList() {
  ...
  const handleLaporanClick = (laporanId: string) => {
    // Arahkan ke halaman detail laporan dengan id laporan
    router.push(`/screens/satgas/LaporanDetail?id=${laporanId}`); // Pastikan pathnya benar
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card} onPress={() => handleLaporanClick(item.id)}>
